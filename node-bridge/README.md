...
Same idea as the **Python** bridge in this repo: Exotel streams call audio over WebSocket; this server forwards it to **Google Gemini Live** and streams AI speech back. Use this if you prefer Node.js.
